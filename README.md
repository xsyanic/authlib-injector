# authlib-injector (only skins)
authlib-injector fork enables you to build a Minecraft skin system.

Changes & Features:
- Remove authentication & session (`join` & `hasJoined`), that will be handled by Mojang Servers
- Only skins will be proxied (`/sessionserver/session/minecraft/profile/<string:uuid>`)
- Offline Caching 

> Docs/Wiki coming soon..

## Download
You can download the latest authlib-injector build from releases.
